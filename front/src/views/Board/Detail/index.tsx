...
import './style.css';
import FavoriteListItem from 'types/interface/favorite-lsit-item.interface';
...
import { DeleteBoardResponseDto, GetCommentListResponseDto, IncreaseViewCountResponseDto, PostCommentResponseDto, PutFavoriteResponseDto } from 'apis/response/board';
            ...
            <div className='board-detail-bottom-comment-input-box'>
              <div className='board-detail-bottom-comment-input-container'>
                ...
                <div className='board-detail-bottom-comment-button-box'>
                  <div className={comment===''?'disable-button':'black-button'} onClick={onCommentSubmitButtonClickHandler}>{'댓글등록'}</div>
                </div>
              </div>
            </div>
            }
